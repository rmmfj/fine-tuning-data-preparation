...
for item in data:
    ...
    training_data.append(
        {
            "messages": [
                ...
                {
                    "role": "user",
                    "content": f'你現在是我的造型師。請你根據這件上衣的描述：{item['tags']['上半身']}，推薦我與之搭配的下身，請仿照以下格式，回答無需包含其他資訊：
    ...
    training_data.append(
            ...
            "messages": [
                ...
                {
                    "role": "user",
                    "content": f'你現在是我的造型師。請你根據這件下身的描述：{item['tags']['下半身']}，推薦我與之搭配的上衣，請仿照以下格式，回答無需包含其他資訊：
