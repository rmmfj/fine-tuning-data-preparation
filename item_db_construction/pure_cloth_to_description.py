...
json {
    "clothing_type": "top",
    "description": "顏色:顏色, 服裝類型:類型, 剪裁版型: 描述, 設計特點:描述, 材質:材質, 細節:描述, 領子:描述（無的話回答無）, 袖長:描述（無的話回答無）, 袖口:描述（無的話回答無）"
}
反之，如果是下身，請仿造下方格式回覆：
json {
    "clothing_type": "bottom", 
    "description": "顏色:顏色, 服裝類型:類型, 剪裁版型: 描述, 設計特點:描述, 材質:材質, 細節:描述, 褲長:描述（無的話回答無）, 褲管:描述（無的話回答無）"
}
"""
